  ...
  return (
    <form onSubmit={handleSubmit} className="card p-6 space-y-5">
      ...
      <div>
        ...
        />
        <p className="text-xs text-luxor-navy/60 mt-1">اكتب رقمك المصري بصيغته الطبيعية المبدوءة بـ 0 (مثال: 01012345678) — المقدّمة +2 ثابتة وسيتواصل العملاء معك مباشرة عبر هذا الرقم</p>
      </div>
